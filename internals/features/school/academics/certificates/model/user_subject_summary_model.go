...
type UserSubjectSummary struct {
	...
	UserSubjectSummarySchoolID          uuid.UUID  `gorm:"column:user_subject_summary_school_id;type:uuid;not null" json:"user_subject_summary_school_id"`
	UserSubjectSummarySchoolStudentID   uuid.UUID  `gorm:"column:user_subject_summary_school_student_id;type:uuid;not null" json:"user_subject_summary_school_student_id"`
