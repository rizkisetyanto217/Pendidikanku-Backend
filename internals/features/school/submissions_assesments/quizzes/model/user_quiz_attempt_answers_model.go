...
type UserQuizAttemptAnswerModel struct {
	...
	// Secara logis mengacu ke quiz_items(question_id)
	...
	// SINGLE: option_id; ESSAY: NULL
	UserQuizAttemptAnswersSelectedOptionID *uuid.UUID `json:"user_quiz_attempt_answers_selected_option_id" gorm:"column:user_quiz_attempt_answers_selected_option_id;type:uuid"`

	// ESSAY: text; SINGLE: NULL
	UserQuizAttemptAnswersText *string `json:"user_quiz_attempt_answers_text" gorm:"column:user_quiz_attempt_answers_text;type:text"`
