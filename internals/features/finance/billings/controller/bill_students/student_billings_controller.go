...
/* =========================
   List (GET /spp/student-bills)
   school_id diambil dari token
========================= */
...
func (h *StudentBillHandler) List(c *fiber.Ctx) error {
	...
	if v := strings.TrimSpace(c.Query("student_id")); v != "" {
		if strings.EqualFold(v, "me") {
			...
			q = q.Where("student_bill_school_student_id = ?", studentID)
...
/* =========================
   Update (PATCH /spp/student-bills/:id)
   school_id diambil dari token
========================= */
...
/* =========================
   Delete (soft) — DELETE /spp/student-bills/:id
   school_id diambil dari token
========================= */
...
/* =========================
   Status change
   POST /spp/student-bills/:id/cancel
   school_id diambil dari token
========================= */
