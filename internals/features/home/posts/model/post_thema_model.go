...
type PostThemeModel struct {
	...
	PostThemeSchoolID  string         `gorm:"column:post_theme_school_id;type:uuid;not null" json:"post_theme_school_id"`
	...
	// Relations (opsional)
	School *SchoolModel.SchoolModel `gorm:"foreignKey:PostThemeSchoolID;references:SchoolID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE"`
