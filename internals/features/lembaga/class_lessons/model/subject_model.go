...
// SubjectsModel merepresentasikan tabel "subjects"
type SubjectsModel struct {
	...
	SubjectsDeletedAt *time.Time  `gorm:"column:subjects_deleted_at" json:"subjects_deleted_at,omitempty"` // ⬅️ tambahan untuk soft delete
}

// TableName set nama tabel sesuai DB
func (SubjectsModel) TableName() string {
	return "subjects"
}
