...
type UIThemeCustomPreset struct {
	...
	UIThemeCustomPresetMasjidID  uuid.UUID      `gorm:"column:ui_theme_custom_preset_masjid_id;type:uuid;not null;index:ux_custom_preset_tenant_code,unique" json:"ui_theme_custom_preset_masjid_id"`
