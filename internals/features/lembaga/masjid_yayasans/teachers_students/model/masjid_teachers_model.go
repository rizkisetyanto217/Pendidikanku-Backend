// file: internals/features/school/teachers/model/masjid_teacher_model.go
package model
...
type MasjidTeacherModel struct {
	...
	MasjidTeacherMasjidIconURLSnapshot      *string `gorm:"type:text;column:masjid_teacher_masjid_icon_url_snapshot" json:"masjid_teacher_masjid_icon_url_snapshot,omitempty"`
	MasjidTeacherMasjidBackgroundURLSnapshot *string `gorm:"type:text;column:masjid_teacher_masjid_background_url_snapshot" json:"masjid_teacher_masjid_background_url_snapshot,omitempty"`

	// JSONB: sections & csst (NOT NULL DEFAULT '[]'::jsonb)
	MasjidTeacherSections datatypes.JSON `gorm:"type:jsonb;not null;default:'[]'::jsonb;column:masjid_teacher_sections" json:"masjid_teacher_sections"`
	MasjidTeacherCSST     datatypes.JSON `gorm:"type:jsonb;not null;default:'[]'::jsonb;column:masjid_teacher_csst" json:"masjid_teacher_csst"`
