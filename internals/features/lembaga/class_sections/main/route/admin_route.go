...
import (
	sectionctrl "masjidku_backend/internals/features/lembaga/class_sections/main/controller"
...
func ClassSectionAdminRoutes(r fiber.Router, db *gorm.DB) {
	...
	sections.Get("/", sectionH.ListClassSections)
	...
	userClassSections.Get("/", ucsH.ListUserClassSections)
