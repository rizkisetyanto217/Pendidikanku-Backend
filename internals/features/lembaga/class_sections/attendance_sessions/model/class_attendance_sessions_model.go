...
type ClassAttendanceSessionModel struct {
	...
	ClassAttendanceSessionTeacherUserId *uuid.UUID `gorm:"type:uuid;column:class_attendance_sessions_teacher_user_id" json:"class_attendance_sessions_teacher_user_id,omitempty"`
