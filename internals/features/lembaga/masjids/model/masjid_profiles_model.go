...
type MasjidProfileModel struct {
	...
	// Koordinat
	MasjidProfileLatitude  *float64 `gorm:"type:numeric(9,6);column:masjid_profile_latitude"  json:"masjid_profile_latitude,omitempty"`
	MasjidProfileLongitude *float64 `gorm:"type:numeric(9,6);column:masjid_profile_longitude" json:"masjid_profile_longitude,omitempty"`
	...
	MasjidProfileSchoolPhone            *string    `gorm:"type:varchar(30);column:masjid_profile_school_phone"         json:"masjid_profile_school_phone,omitempty"`
