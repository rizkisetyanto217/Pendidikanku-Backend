...
type BooksModel struct {
	...
	BooksImageURL *string  `gorm:"column:books_image_url;type:text"      json:"books_image_url,omitempty"`
	BooksURL      *string  `gorm:"column:books_url;type:text"            json:"books_url,omitempty"`

	// slug nullable (unik per masjid; partial unique index di SQL)
	...
	BooksUpdatedAt *time.Time     `gorm:"column:books_updated_at;autoUpdateTime"           json:"books_updated_at,omitempty"`
