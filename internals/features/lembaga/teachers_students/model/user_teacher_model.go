...
type UserTeacher struct {
	...
	// FK (unik per user)
	UsersTeacherUserID uuid.UUID `gorm:"column:users_teacher_user_id;type:uuid;not null;uniqueIndex:uq_user_teachers_user" json:"users_teacher_user_id"`
	...
	UsersTeacherLongBio         *string `gorm:"column:users_teacher_long_bio;type:text" json:"users_teacher_long_bio,omitempty"`
