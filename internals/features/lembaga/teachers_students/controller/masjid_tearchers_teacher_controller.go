...
import (
	...
	yDTO "masjidku_backend/internals/features/lembaga/teachers_students/dto"     // DTO response masjid_teachers
	yModel "masjidku_backend/internals/features/lembaga/teachers_students/model" // model masjid_teachers
)
