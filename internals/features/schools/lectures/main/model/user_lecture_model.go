...
type UserLectureModel struct {
	...
	// 🔗 School
	UserLectureSchoolID uuid.UUID `gorm:"column:user_lecture_school_id;type:uuid;not null" json:"user_lecture_school_id"`

	// Progress
	UserLectureGradeResult            *int `gorm:"column:user_lecture_grade_result" json:"user_lecture_grade_result,omitempty"` // 0–100
	...
	UserLectureUpdatedAt time.Time      `gorm:"column:user_lecture_updated_at;autoUpdateTime" json:"user_lecture_updated_at"`
	UserLectureDeletedAt gorm.DeletedAt `gorm:"column:user_lecture_deleted_at;index" json:"user_lecture_deleted_at,omitempty"`
}
