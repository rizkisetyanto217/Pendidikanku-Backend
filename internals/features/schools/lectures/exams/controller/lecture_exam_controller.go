...
import (
	modelLectureSessionQuestion "schoolku_backend/internals/features/schools/lecture_sessions/questions/model"
...
func (ctrl *LectureExamController) CreateLectureExam(c *fiber.Ctx) error {
	// Ambil school_id dari token (middleware harus set)
	...
	newExam := model.LectureExamModel{
		...
		LectureExamSchoolID:    schoolID.(string),
	}
