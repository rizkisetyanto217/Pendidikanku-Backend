...
type LectureSessionsQuizDTO struct {
	...
	LectureSessionsQuizSchoolID         string    `json:"lecture_sessions_quiz_school_id"`
...
// Create Request DTO
// ============================
// catatan: school_id diambil dari token scope di controller, bukan dari request body
...
func (r *CreateLectureSessionsQuizRequest) ToModel(schoolID string) *model.LectureSessionsQuizModel {
	return &model.LectureSessionsQuizModel{
		...
		LectureSessionsQuizSchoolID:         schoolID, // dari token scope
	}
}
...
func ToLectureSessionsQuizDTO(m model.LectureSessionsQuizModel) LectureSessionsQuizDTO {
	return LectureSessionsQuizDTO{
		...
		LectureSessionsQuizSchoolID:         m.LectureSessionsQuizSchoolID,
