...
type LectureSessionsUserQuestionDTO struct {
	...
	LectureSessionsUserQuestionSchoolID   string    `json:"lecture_sessions_user_question_school_id"`
...
type CreateLectureSessionsUserQuestionRequest struct {
	...
	LectureSessionsUserQuestionSchoolID   string `json:"lecture_sessions_user_question_school_id" validate:"required,uuid"`
}
...
func ToLectureSessionsUserQuestionDTO(m model.LectureSessionsUserQuestionModel) LectureSessionsUserQuestionDTO {
	return LectureSessionsUserQuestionDTO{
		...
		LectureSessionsUserQuestionSchoolID:   m.LectureSessionsUserQuestionSchoolID,
