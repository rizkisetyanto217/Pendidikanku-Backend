...
type SppBillingModel struct {
	...
	SppBillingTermID *uuid.UUID `gorm:"column:spp_billing_term_id;type:uuid" json:"spp_billing_term_id,omitempty"`
	...
	// Timestamps (DB punya DEFAULT/trigger)
	...
	// (Opsional) contoh preload relasi – sesuaikan nama model lain kalau ada
	// Term   *AcademicTermModel `gorm:"foreignKey:SppBillingTermID;references:AcademicTermsID" json:"-"`
