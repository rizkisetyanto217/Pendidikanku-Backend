...
DROP INDEX IF EXISTS idx_uls_user_school_created_desc;
...
DROP INDEX IF EXISTS idx_ls_school_active_created_desc;
DROP INDEX IF EXISTS idx_ls_lecture_start;
DROP INDEX IF EXISTS idx_ls_teacher_start;
DROP INDEX IF EXISTS idx_ls_school_active_start;
