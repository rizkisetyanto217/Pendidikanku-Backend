...
DROP INDEX IF EXISTS idx_ucae_urls_school_sender;
...
-- ================================
DROP INDEX IF EXISTS idx_user_class_attendance_events_school_user;
DROP INDEX IF EXISTS idx_user_class_attendance_events_checkedin;
DROP INDEX IF EXISTS idx_user_class_attendance_events_school_rsvp;
...
DROP INDEX IF EXISTS idx_class_attendance_event_urls_school_live;
...
-- ================================
DROP INDEX IF EXISTS idx_class_attendance_events_school;
